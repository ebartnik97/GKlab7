...
public class Lab7 extends JPanel implements GLEventListener {
    ...
    private void drawCurrentShape(GL2 gl2) {
        switch (currentObjectNum) {
            ...
            case 6:
                ...
                break;
            case 7:
                // Transforms context to the center and draws pyramid (more comments in uvPyramid() impltementation).
                gl2.glRotated(-90, 1, 0, 0);
                gl2.glTranslated(0, 0, -0.4);
    ...
    private Texture textureFromResource(String resourceName) throws IOException {
        ...
        BufferedImage img = ImageIO.read(requireNonNull(textureURL));
    ...
    JMenuBar getMenuBar() {
        ...
        ActionListener textureListener = e -> {
            ...
            switch (itemNum) {
                ...
                case 3:
                    try {
                        currentTexture = textureFromResource("src/earth.jpg");
                ...
                case 4:
                    try {
                        currentTexture = textureFromResource("src/brick.jpg");
                    } catch (IOException ex) {
                        ex.printStackTrace();
                    }
                    break;
                case 5:
                    try {
                        currentTexture = textureFromResource("src/clouds.jpg");
                    } catch (IOException ex) {
                        ex.printStackTrace();
                    }
                    break;
